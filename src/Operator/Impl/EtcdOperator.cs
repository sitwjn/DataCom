...
{
    internal class EtcdOperator : AbstractOperator, IOperator, INoSOperator
    {
        public EtcdOperator(DCredential credential) 
        {
            base.Handler = new EtcdHandler(new EtcdConn(credential));
        }

        public EtcdOperator(string connStr)
        {
            base.Handler = new EtcdHandler(new EtcdConn(connStr));
        }
